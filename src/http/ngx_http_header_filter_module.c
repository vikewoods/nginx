...
static char ngx_http_server_string[] = "Server: VE Development [Frontend balance-loader] " CRLF;
static char ngx_http_server_full_string[] = "Server: VE Development [Frontend balance-loader] " CRLF;
